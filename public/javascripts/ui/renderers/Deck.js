class Card {
    ...
    draw() {
        ...
        stroke(0);
        strokeWeight(2);
        text("AP: " + this.card.APcost,this.x+Card.width*0.655,this.y+Card.height*0.095);
        text("RP: " + this.card.RPcost,this.x+Card.width*0.655,this.y+Card.height*0.205);
        strokeWeight(1);
        noStroke();
        fill(0);
        textSize(16);
        text(this.card.name,this.x+Card.width*0.5,this.y+Card.height*0.47);
        textSize(12);
